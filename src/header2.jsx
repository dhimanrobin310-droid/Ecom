                ...
                <div class="col-sm-12">
                    <div class="main-menu">
                        <div class="menu-left around-border">
                            <div class="navbar"> <a href="#!" onclick="openNav()"><i class="ri-bar-chart-horizontal-line sidebar-bar"></i></a>
                                                ...
                                                <ul class="mega-menu clothing-menu">
                                                    <li>
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#!" class="mega-menu-banner"><img src="../assets/images/mega-menu/bag.jpg" alt="" class="img-fluid blur-up lazyload"/></a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                                                        ...
                                                        <div class="row g-xl-4 g-0">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            <li><a href="elements.html">
                                                                                    elements page<i class="ms-2 fa fa-bolt icon-trend"></i>
                                                                                </a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col mega-box">
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            <li><a href="index.html">bottom<i class="ms-2 fa fa-bolt icon-trend"></i></a>
                                                                            </li>
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            <li><a href="marketplace-demo-2.html">ajax
                                                                                    search<i class="ms-2 fa fa-bolt icon-trend"></i></a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            ...
                                                                            <li><a href="index.html">exit<i class="ms-2 fa fa-bolt icon-trend"></i></a>
                                                                            </li>
                        ...
                        <div class="absolute-logo">
                            <div class="brand-logo">
                                <a href="index.html" class="d-block">
                                    <img alt="" src="../assets/images/electronics-2/logo.png"/>
                                </a>
                            </div>
                        </div>
                        <div>
